...
#ifndef GB2312_UNICODE_H_
#define GB2312_UNICODE_H_
#include "stdint.h"
//区位码(十进制) + $A0A0 = GBK内码(十六进制)
//GBK的code page是CP936，BIG5的code page是CP950，GB2312的code page是CP20936
//extern const uint16_t GB2312ToUnicode_Tab[][2];
//extern const uint16_t UnicodeToGB2312_Tab[][2];
#if 1
const uint16_t GB2312ToUnicode_Tab[8520][2] =
{
  {0xA1A1, 0x3000},  /* '　' -> 12288 */
  {0xA1A2, 0x3001},  /* '、' -> 12289 */
  {0xA1A3, 0x3002},  /* '。' -> 12290 */
...
#endif
#if 1
const uint16_t UnicodeToGB2312_Tab[][2] =
{
	{0x00A4, 0xA1E8},
	{0x00A7, 0xA1EC},
	{0x00A8, 0xA1A7},
